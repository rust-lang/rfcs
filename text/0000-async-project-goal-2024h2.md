...
* [resolving the "send bound problem"](#resolve-the-send-bound-problem), thus enabling foundational, generic traits like Tower's [`Service`](https://docs.rs/tower/latest/tower/trait.Service.html) trait;
