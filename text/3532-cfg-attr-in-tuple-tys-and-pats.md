- Feature Name: `cfg_attr_in_tuple_tys_and_pats`
...
Let's make it more elegant to conditionally compile tuple type declarations and pattern matches by allowing (outer) cfg-attributes directly on their elements.
