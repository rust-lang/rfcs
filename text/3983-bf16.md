...
The types and operations for vectors will be provided by `core::arch`, for the moment. As is usual for these operations their semantics are architecture specific. Where similar instructions between plaftorms should not be expected to produce the same results.
