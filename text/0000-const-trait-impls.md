...
// this is a non-const `impl` as allocating on the heap is not supported in const yet
...
You can make trait impls of many standard library traits for your own types `const`.
